...
inputloc = "G:\\My Drive\\DOWNLOAD_TADAS_DATA_VIA_PYTHON"

outputloc = "G:\\My Drive\\DOWNLOAD_TADAS_DATA_VIA_PYTHON\\EQ_BASED_DATA_DOWNLOAD"

eq_list = ["20260411143156_SIMAV_KUTAHYA_EQ_MW_4_8.xlsx"]

for i_eq in eq_list:
    
    eq_data = pd.read_excel(inputloc+"\\"+i_eq, sheet_name="data")
    
    if not os.path.exists(outputloc+"\\"+i_eq.split(".xlsx")[0]):
        os.makedirs(outputloc+"\\"+i_eq.split(".xlsx")[0])
    
    for i_code in eq_data["Code"]:

        # The data-raw part, converted to a Python dictionary
        data = {
            "filename": [i_eq.split("_")[0]+"_"+i_code],
            "file_type": ["ap"],
            "file_status": "Acc",
            "export_type": "asc2",
            "user_name": "GuestUser",
        ...
        output_filename = outputloc+"\\"+i_eq.split(".xlsx")[0]+"\\"+i_eq.split("_")[0]+"_"+i_code+".zip"
